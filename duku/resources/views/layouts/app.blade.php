        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <div class="sidebar bg-gray-800 text-white">
                ...
                <nav class="flex-1 px-2 py-4 space-y-2">
                    ...
                    <!-- Reports Link -->
                    <a href="{{ route('reports.index') }}" class="flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-gray-700 {{ request()->routeIs('reports.index') ? 'bg-gray-700' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 mr-3">
